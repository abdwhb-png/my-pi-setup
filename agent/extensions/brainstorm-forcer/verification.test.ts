...
describe("verification routing", () => {
    ...
    it("includes artifact search in the read-only allowlist without Think execution", () => {
        expect(READONLY_VERIFIER_TOOLS).toContain("think_artifact_search");
        expect(READONLY_VERIFIER_TOOLS).not.toContain("think_execute");
