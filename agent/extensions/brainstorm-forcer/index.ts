    ...
    switch (phase) {
        ...
        case "exploring":
            return [
                ...
                `Critical claims supported by \`ctx_search\`/\`think_artifact_search\` need direct corroboration. Failed, stale, indexed-only, secondary, or verifier evidence cannot independently verify a critical empirical claim.`,
