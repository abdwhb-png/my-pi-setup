/**
 * Safe Bash installer used by the Bash Execution extension.
 * Adds a guarded Bash surface without owning a Pi entrypoint.
 *
...
export interface SafeBashRegistrationOptions {
    createOperations(options: SandboxBashOperationOptions): BashOperations;
}

export function registerSafeBash(
    pi: ExtensionAPI,
    options: SafeBashRegistrationOptions,
): void {
