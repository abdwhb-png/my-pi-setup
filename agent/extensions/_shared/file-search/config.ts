/**
 * Shared file-resolver configuration.
 *
 ...
 *
 * Runtime state remains owned by pi-overrides; this module only owns the
 * portable contract and configuration loading behavior.
 */
