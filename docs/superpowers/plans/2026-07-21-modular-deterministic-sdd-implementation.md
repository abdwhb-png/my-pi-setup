...
- [ ] **Step 2: Run the tracer test and observe RED**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/plan-parser.test.ts
...
- [ ] **Step 7: Refactor the old test file into an index import smoke test**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/plan-parser.test.ts extensions/sdd-orchestrator/sdd-orchestrator.test.ts
...
~~~sdd-task
{"id":"task-2","dependsOn":["task-1"],"files":["agent/extensions/sdd-orchestrator/assessment.ts","agent/extensions/sdd-orchestrator/classification.ts","agent/extensions/sdd-orchestrator/classification.test.ts"],"verify":[{"id":"task-2-tests","command":"cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/classification.test.ts extensions/sdd-orchestrator/plan-parser.test.ts"}]}
~~~
...
- [ ] **Step 1: RED for one critical signal**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/classification.test.ts
...
- [ ] **Step 6: Verify**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/classification.test.ts extensions/sdd-orchestrator/plan-parser.test.ts
...
~~~sdd-task
{"id":"task-3","dependsOn":["task-1","task-2"],"files":["agent/extensions/sdd-orchestrator/config.ts","agent/extensions/sdd-orchestrator/config.test.ts","agent/extensions/sdd-orchestrator/manifest.ts","agent/extensions/sdd-orchestrator/manifest.test.ts"],"verify":[{"id":"task-3-tests","command":"cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/config.test.ts extensions/sdd-orchestrator/manifest.test.ts"}]}
~~~
...
- [ ] **Step 6: Verify**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/config.test.ts extensions/sdd-orchestrator/manifest.test.ts
...
~~~sdd-task
{"id":"task-4","dependsOn":["task-3"],"files":["agent/extensions/sdd-orchestrator/state-machine.ts","agent/extensions/sdd-orchestrator/state-machine.test.ts","agent/extensions/sdd-orchestrator/store.ts","agent/extensions/sdd-orchestrator/store.test.ts"],"verify":[{"id":"task-4-tests","command":"cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/state-machine.test.ts extensions/sdd-orchestrator/store.test.ts"}]}
~~~
...
- [ ] **Step 6: Verify**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/state-machine.test.ts extensions/sdd-orchestrator/store.test.ts
...
~~~sdd-task
{"id":"task-5","dependsOn":["task-4"],"files":["agent/extensions/sdd-orchestrator/delegation-client.ts","agent/extensions/sdd-orchestrator/delegation-client.test.ts"],"verify":[{"id":"task-5-tests","command":"cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/delegation-client.test.ts"},{"id":"task-5-types","command":"cd /home/abdwhb/.pi/agent && bun run typecheck"}]}
~~~
...
- [ ] **Step 1: RED for request and correlated response**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/delegation-client.test.ts
...
- [ ] **Step 6: Verify package resolution and focused tests**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun run typecheck
...
~~~sdd-task
{"id":"task-6","dependsOn":["task-1","task-5"],"files":["agent/extensions/sdd-orchestrator/prompts.ts","agent/extensions/sdd-orchestrator/prompts.test.ts","agent/agents/orchestration-assessor.md","agent/agents/sdd-combined-reviewer.md","agent/agents/sdd-spec-reviewer.md","agent/agents/sdd-quality-reviewer.md"],"verify":[{"id":"task-6-tests","command":"cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/prompts.test.ts"},{"id":"task-6-parse","command":"cd /home/abdwhb/.pi/agent && bun run check:parse"}]}
~~~
...
- [ ] **Step 7: Verify**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/prompts.test.ts

    Run: cd /home/abdwhb/.pi/agent && bun run check:parse
...
~~~sdd-task
{"id":"task-7","dependsOn":["task-2","task-3","task-4","task-5","task-6"],"files":["agent/extensions/sdd-orchestrator/workflow.ts","agent/extensions/sdd-orchestrator/workflow.test.ts"],"verify":[{"id":"task-7-tests","command":"cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/workflow.test.ts"}]}
~~~
...
- [ ] **Step 9: Verify profile ceilings**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/workflow.test.ts
...
- [ ] **Step 9: Verify**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator
...
~~~sdd-task
{"id":"task-9","dependsOn":["task-8"],"files":["agent/roles/plan.md","agent/roles/quick-planner.md","agent/agents/sdd-orchestrator.md","agent/extensions/sdd-orchestrator/migration.test.ts"],"verify":[{"id":"task-9-tests","command":"cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/migration.test.ts"}]}
~~~
...
- [ ] **Step 6: Verify**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/migration.test.ts

    Run: sha256sum /home/abdwhb/.pi/agent/.sdd/queue/sdd-mqxpovpu-8m9fgo.json /home/abdwhb/.pi/agent/.sdd/progress/sdd-mqxpovpu-8m9fgo.json
...
~~~sdd-task
{"id":"task-10","dependsOn":["task-8","task-9"],"files":["agent/extensions/sdd-orchestrator/sdd-orchestrator.integration.test.ts","docs/plans/2026-07-21-modular-deterministic-sdd-design.md"],"verify":[{"id":"focused-tests","command":"cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator"},{"id":"full-tests","command":"cd /home/abdwhb/.pi/agent && bun test --isolate"},{"id":"typecheck","command":"cd /home/abdwhb/.pi/agent && bun run typecheck"},{"id":"lint","command":"cd /home/abdwhb/.pi/agent && bun run lint"},{"id":"format","command":"cd /home/abdwhb/.pi/agent && bun run fmt:check"},{"id":"parse","command":"cd /home/abdwhb/.pi/agent && bun run check:parse"}]}
~~~
...
- [ ] **Step 7: Run mandatory verification gates**
    ...
    Run: cd /home/abdwhb/.pi/agent && bun test --isolate
    ...
    Run: cd /home/abdwhb/.pi && git diff --check

    Expected: no whitespace errors.

- [ ] **Step 8: Inspect unwanted artifacts**

    Run: cd /home/abdwhb/.pi && git status --short
...
~~~sdd-task
{"id":"task-11","dependsOn":["task-10"],"files":["agent/extensions/sdd-orchestrator/plan-parser.ts","agent/extensions/sdd-orchestrator/plan-parser.test.ts","agent/extensions/sdd-orchestrator/workflow.ts","agent/extensions/sdd-orchestrator/workflow.test.ts","agent/extensions/sdd-orchestrator/review-ui.ts","agent/extensions/sdd-orchestrator/review-ui.test.ts","agent/extensions/sdd-orchestrator/extension-tools.ts","agent/extensions/sdd-orchestrator/sdd-orchestrator.test.ts","agent/extensions/sdd-orchestrator/pi-runtime.integration.test.ts","docs/plans/2026-07-21-modular-deterministic-sdd-design.md"],"verify":[{"id":"focused-tests","command":"cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator"},{"id":"full-tests","command":"cd /home/abdwhb/.pi/agent && bun test --isolate"},{"id":"typecheck","command":"cd /home/abdwhb/.pi/agent && bun run typecheck"},{"id":"lint","command":"cd /home/abdwhb/.pi/agent && bun run lint"},{"id":"format","command":"cd /home/abdwhb/.pi/agent && bun run fmt:check"},{"id":"parse","command":"cd /home/abdwhb/.pi/agent && bun run check:parse"}]}
~~~
...
~~~sdd-task
{"id":"task-12","dependsOn":["task-11"],"files":["agent/roles/planning-base.md","agent/roles/plan.md","agent/roles/sdd-plan.md","agent/roles/quick-planner.md","agent/extensions/sdd-orchestrator/migration.test.ts","docs/plans/2026-07-21-modular-deterministic-sdd-design.md"],"verify":[{"id":"migration-tests","command":"cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator/migration.test.ts"},{"id":"focused-tests","command":"cd /home/abdwhb/.pi/agent && bun test extensions/sdd-orchestrator"},{"id":"parse","command":"cd /home/abdwhb/.pi/agent && bun run check:parse"}]}
~~~
